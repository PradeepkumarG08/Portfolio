    ...
    return <section id="contact" className="py-24 px-4 relative">
        <div className="container mx-auto max-w-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="space-y-8">
                    ...
                    <div className="space-y-6 items-center justify-center">
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                <h4 className="font-medium w-3">Email</h4>
                                <a href="mailto:pradeepg2468@gmail.com" className="text-secondary hover:text-primary transition-colors">pradeepg2468@gmail.com</a>
                            </div>
                    ...
                    <div className="space-y-6 items-center justify-center">
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <a href="tel:+1234567890" className="text-secondary hover:text-primary transition-colors">+91 9940744382</a>
                            </div>
                    ...
                    <div className="pt-8 text-white">
                        ...
                        <div className="flex space-x-4 justify-center">
                            <a  href="#" target="https://wwww.linkedin.com/in/pradeepkumar-g-a59412336?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app">
                                <Linkedin/>
                            </a>
                ...
                <div className="bg-card p-8 rounded-lg shadow-xs text-black">
                    ...
                    <form action="" className="space-y-6">
                        <div>
                            ...
                            focuse:ring-2 focus:ring-primary" required placeholder="Enter Your Name ....." />
                        </div>
                        <div>
