    ...
    >
        <div className="container max-w-4xl mx-auto text-center z-10">
            <div className="space-y-6">
                <h1 className="tex-4xl md:text-6xl font-bold"><div>
                    <span className="text-secondary opacity-0 animate-fade-in">G.PRADEEPKUMAR </span></div>
                    <span className="text-secondary opacity-0 animate-fade-in">Hi ,I'm </span>
                    <span className="text-primary opacity-0 animate-fade-in-delay-1"> MERN STACK</span>
